...
selected_items = [
    ...
    "Pepper (Piper spp.), raw", "Pineapples", "Pomelos and grapefruits", "Potatoes", "Rice",
    "Rice, paddy (rice milled equivalent)", "Sesame seed", "Soya beans", "Sugar cane", "Sweet potatoes", "Tea leaves",
